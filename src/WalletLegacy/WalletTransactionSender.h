...
public:
  ...
  std::shared_ptr<WalletRequest> makeSendDustRequest(TransactionId& transactionId,
                                                     std::deque<std::unique_ptr<WalletLegacyEvent>>& events,
                                                     const std::vector<WalletLegacyTransfer>& transfers,
                                                     uint64_t fee,
                                                     const std::string& extra                        = "",
  ...
  std::shared_ptr<WalletRequest> makeSendFusionRequest(TransactionId& transactionId,
                                                       std::deque<std::unique_ptr<WalletLegacyEvent>>& events,
                                                       const std::vector<WalletLegacyTransfer>& transfers,
...
private:
  ...
  bool checkIfEnoughMixins(const std::vector<RandomOuts>& outs, uint64_t mixIn);
  ...
  uint64_t selectDustTransfersToSend(uint64_t neededMoney, uint64_t dust, std::vector<TransactionOutputInformation>& selectedTransfers);
