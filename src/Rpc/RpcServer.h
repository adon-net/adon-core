...
public:
  ...
  bool mn_check_incoming_tx(const BinaryArray& tx_blob);
...
private:
  ...
  bool on_check_tx_with_view_key(const COMMAND_RPC_CHECK_TX_WITH_PRIVATE_VIEW_KEY::request& req, COMMAND_RPC_CHECK_TX_WITH_PRIVATE_VIEW_KEY::response& res);
  bool on_check_tx_proof(const COMMAND_RPC_CHECK_TX_PROOF::request& req, COMMAND_RPC_CHECK_TX_PROOF::response& res);
