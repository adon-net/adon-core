...
private:
  void loadKeyListAndBalalces(CryptoNote::ISerializer& serializer, bool saveCache);
  void saveKeyListAndBalalces(CryptoNote::ISerializer& serializer, bool saveCache);
