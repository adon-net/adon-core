...
void WalletSerializerV2::load(Common::IInputStream& source, uint8_t version) {
  ...
  loadKeyListAndBalalces(s, saveLevel == WalletSaveLevel::SAVE_ALL);
...
void WalletSerializerV2::save(Common::IOutputStream& destination, WalletSaveLevel saveLevel) {
  ...
  saveKeyListAndBalalces(s, saveLevel == WalletSaveLevel::SAVE_ALL);
...
void WalletSerializerV2::loadKeyListAndBalalces(CryptoNote::ISerializer& serializer, bool saveCache) {
  size_t walletCount;
...
void WalletSerializerV2::saveKeyListAndBalalces(CryptoNote::ISerializer& serializer, bool saveCache) {
