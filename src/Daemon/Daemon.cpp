...
//   if (boost::filesystem::exists(dataDirPath)) {
//     return;
//   }

//   std::string dataDirPrefix = dataDir.substr(0, dataDir.size() + 1 - sizeof(CRYPTONOTE_NAME));

//   boost::filesystem::path darkNoteDirPath(dataDirPrefix + "darknote");
//   if (boost::filesystem::exists(darkNoteDirPath)) {
//     boost::filesystem::rename(darkNoteDirPath, dataDirPath);
//   } else {
...
//       boost::filesystem::rename(duckNoteDirPath, dataDirPath);
//     }
//   }
// }
